...
## Mobile PDF Scanning (examples: Scannable, CamScanner)
* [Drag PDF](https://github.com/vicajilau/Drag-PDF) [🟢](https://github.com/vicajilau/Drag-PDF) Support here: [Donate to primary dev](https://buymeacoffee.com/vicajilau)
...
* [LMMS](https://lmms.io/) [🟢](https://github.com/LMMS/lmms) Support here: [Donate to LMMS](https://github.com/LMMS/lmms)
* [Qtractor](https://qtractor.org/) [🟢](https://github.com/rncbc/qtractor) Support here: [Donate to primary dev](https://liberapay.com/rncbc/donate)
...
* [Localsend](https://localsend.org/#/) [🟢](https://github.com/localsend/localsend) Support here: [Primary dev](https://github.com/sponsors/Tienisto)

## Office Suites (examples: Microsoft Office, Google Workspace)
* [LibreOffice](https://www.libreoffice.org/) [🟢](https://github.com/LibreOffice/core) Support here: [Donate to LibreOffice](https://www.libreoffice.org/donate/)
...
* [Kan](https://kan.bn/) [🔴](https://github.com/kanbn/kan)
...
* [Actual](https://actualbudget.org/) [🟢](https://github.com/actualbudget/actual) Support here: [Donate to Actual Budget](https://opencollective.com/actual)
...
* High Tide [🟢](https://github.com/Nokse22/high-tide) Support here: [Donate to primary dev](https://ko-fi.com/nokse22)
...
* [OpenToonz](https://opentoonz.github.io/e/index.html) [🔴](https://github.com/opentoonz/opentoonz)
* [Blender](https://www.blender.org/) [🟢](https://github.com/blender/blender) Support here: [Blender Development Fund](https://fund.blender.org/?utm_medium=www-nav)
* [Krita](https://krita.org/en/) [🟢](https://invent.kde.org/graphics/krita) Support here: [Krita development fund](https://fund.krita.org/)

## Computer-aided Drawing (examples: AutoCAD)
* [FreeCAD](https://www.freecad.org/) [🟢](https://github.com/FreeCAD/FreeCAD) Support here: [Donate to FreeCAD](https://www.freecad.org/sponsor.php)
* [LibreCAD](https://librecad.org/) [🟢](https://github.com/LibreCAD/LibreCAD) Support here: [Donate to LibreCAD](https://librecad.org/donate.html)
...
* [OBS Studio](https://obsproject.com/) [🟢](https://github.com/obsproject/obs-studio) Support here: [Donate to the OBS Project](https://obsproject.com/contribute)
...
* [Celestia](https://celestiaproject.space/) [🟢](https://github.com/CelestiaProject/Celestia) Support by improving the project!
* [Stellarium](https://stellarium.org/) [🟢](https://github.com/Stellarium/stellarium) Support here: [Donate to Stellarium](https://opencollective.com/stellarium)

## Vehicle Autopilot (examples: Tesla Autopilot, Cruise, Waymo)
* [Openpilot](https://comma.ai/openpilot)<sup>[13]</sup> [🔴](https://github.com/commaai/openpilot)
...
[17] Same as with email, while routing your traffic to a secondary IP address may be *better* than just going into the web raw, if that IP address isn't under your purview, someone else (i.e. a company) is still capable of viewing your data. Maybe not your ISP, but someone else nonetheless. If you want a VPN for geospoofing reasons and the security/privacy aspect isn't a concern, then this doesn't really matter. However, if your motivation for using a VPN is to "take your data back" from your ISP, using a corporate-backed VPN service is just kicking the rock down the road. In this case, I would recommend privately hosting your own VPN server with something like [Linode](https://www.linode.com/)/[Akamai](https://www.akamai.com/), or even a dedicated device. There are plenty of tutorials on how to this, such as [this one](https://www.youtube.com/results?search_query=how+to+et+up+wireguard+vpn), [these ones](https://www.digitalocean.com/community/tutorial-collections/how-to-set-up-an-openvpn-server), and plenty others.
